...
import { SiReact, SiTypescript, SiTailwindcss, SiElectron, SiVite, SiJavascript, SiNodedotjs, SiFastify, SiPostgresql, SiPrisma, SiRedis, SiDocker, SiGit, SiVitest, SiPython, SiC, SiFlask } from "react-icons/si";
